...
def main():
    ...
    with st.expander("Instructions to upload Text PDF/URL"):
        ...
        st.write("4. After loading documents, click 'Create Vector Store' to process.Documents can only be uploaded once per session. This will take some time. Feel free to get your questions framed during this time.")
        ...
        st.write("Made by Harsh Tripathi and Shubham Soni. Make sure to follow us on our socials !")
